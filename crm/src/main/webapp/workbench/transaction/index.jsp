...
<script type="text/javascript">
	...
	function showTran() {
		...
		$.ajax({
			url:"workbench/transaction/showTran.do",
			type:"get",
			dataType:"json",
			success:function (date) {
				...
				$.each(date,function (i,n) {
					...
					html+='<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href=\'workbench/transaction/detail.do?tranid='+n.id+'\';">'+n.name+'</a></td>';
